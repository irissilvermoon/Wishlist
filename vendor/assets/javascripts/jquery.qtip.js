 ...
 *
 * Date: Sat Jun 8 2013 08:10 PDT-0700
	...
	init: function(qtip) {
		...
		qtip._bind(tooltip, ['tooltipshow', 'tooltiphide'], function(event, api, duration) {
			...
			if(event.target === tooltip[0]) {
				if(oEvent && event.type === 'tooltiphide' && /mouse(leave|enter)/.test(oEvent.type) && $(oEvent.relatedTarget).closest(qtip.elements.overlay[0]).length) {
